    ...
    <div class="max-w-3xl mx-auto">
        ...
        <section>
            ...
            <div class="text-gray-900 bg-gray-200">
                <div class="p-4 flex text-center items-center">
                    <h1 class="text-3xl ">
                        Users
                    </h1>
                </div>
                    ...
                    <table class="w-full text-md bg-white shadow-md rounded mb-4">
                        <tbody>
                            <tr class="border-b">
                                ...
                                <th class="text-left p-3 px-5">Last Login</th>
                                <th></th>
                            </tr>
                            ...
                            @foreach ($users as $user)
                                <tr class="border-b hover:bg-orange-100">
                                    <td class="p-3 px-5"> {{ $user->name }}
                                    </td>
                                    <td class="p-3 px-5">{{ $user->email }}
                                    </td>
                                    <td class="p-3 px-5">
